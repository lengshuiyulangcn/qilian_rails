class JobsController < ApplicationController
  layout 'admin'
  before_action :permitted_only, except: [:search,:single_search,:detail]
  def index
  ...
  private
  def job_params
    params.require(:job).permit(:id,:title,:comp_name,:content,:detail,:step,:num,:schedule,:position,:expire_at,:image,:location,:target,:source_url,:exstr)
  end
  def get_labels
